...
public class StudentTableFrame extends JFrame {
    ...
    private void loadStudents() {
        ...
        for (Student s : discipline.getStudents()) {
            ...
            tableModel.addRow(new Object[] {
                s.getName(), s.getGrade1(), s.getGrade2(), s.getGrade3(), String.format("%.2f", media)
            });
        }
    }
    ...
    private void adicionarAluno() {
        ...
        if (option == JOptionPane.OK_OPTION) {
            ...
            try {
                ...
                tableModel.addRow(new Object[] {
                    nome, n1, n2, n3, String.format("%.2f", media)
                });
    ...
    private void editarAluno() {
        ...
        Student aluno = discipline.getStudents().stream()
            .filter(s -> s.getName().equals(nomeAtual))
            .findFirst()
            .orElse(null);
